...
@HiltViewModel
internal class ExtensionBottomSheetViewModel @Inject constructor(
    private val preferenceProvider: PreferenceProvider
): ViewModel() {
    private val extensionBottomSheetStateFlow = MutableStateFlow<ExtensionBottomSheetState>(
        ExtensionBottomSheetState.Detail
    )
